        ...
        <header role="banner" className="bg-[#00000070] shadow fixed top-0 left-0 right-0 z-50">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 md:py-5 py-4">
                ...
                <nav className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-semibold uppercase text-xl flex flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row md:space-x-6 md:mt-0 md:border-0 md:bg-transparent border-gray-700">
                        <li>
                        ...
                        <li>
                            <Link href="/fixtures" className="block py-2 pl-2 pr-3 rounded hover:bg-gray-100 md:border-0 md:hover:text-yellow-300 md:p-0 text-white md:hover:bg-transparent duration-150">fixtures</Link>
                        </li>
                        <li>
                            <Link href="https://www.nba.com/team/1610612747/lakers" target="blank" className="block py-2 pl-2 pr-3 rounded hover:bg-gray-100 md:border-0 md:hover:text-yellow-300 md:p-0 text-white md:hover:bg-transparent duration-150">official website</Link>
                        </li>
                        {!user ?
                            <li>
                            ...
                            <>
                                ...
                                <li className="cursor-pointer" onClick={handleSignOut}><span className="block py-2 pl-2 pr-3 rounded hover:bg-gray-100 md:border-0 md:hover:text-yellow-300 md:p-0 text-white md:hover:bg-transparent duration-150" tabIndex={0}>signout</span></li>
                            </>
                        }
                    </ul>
                </nav>
